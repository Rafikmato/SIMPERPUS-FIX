...
function tampil_buku($mysqli)
{
    ...
    ?>
        <option value="<?= $row->id_buku ?>"><?= $row->judul_buku ?> (<?= $kato; ?>) - Stok : <?= $row->jumlah_buku ?></option>
    <?php
    }
}
        ...
        <tr>
            ...
            <td>
                ...
                <?php elseif ($row->jenis == 2) : ?>
                    Buku Pegangan Siswa
                <?php elseif ($row->jenis == 0) : ?>
                    Buku Fiksi
                <?php elseif ($row->jenis == 3) : ?>
                    Buku Non Fiksi
                <?php elseif ($row->jenis == 4) : ?>
                    Buku Referensi
                <?php elseif ($row->jenis == 5) : ?>
                    Buku Ilmu Murni
                <?php else : ?>
                    -
                <?php endif; ?>
            ...
            <td>
                ...
                <?php elseif ($row->kategori_buku == 0) : ?>
                    Fiksi
                <?php elseif ($row->kategori_buku == 2) : ?>
                    Non Fiksi
                <?php elseif ($row->kategori_buku == 3) : ?>
                    Referensi
                <?php elseif ($row->kategori_buku == 4) : ?>
                    Ilmu Murni
                <?php else : ?>
                    -
                <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="kategori" value="<?= $row->kategori_buku ?>">
                                        <input type="text" class="form-control" name="ktg" placeholder="Masukkan Kategori Buku" value="<?= $kateg; ?>" readonly>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="klasifikasi-mp" class="form-control">
                                                <?php
                                                    if ($row->jenis == 1) {
                                                        echo "
                                                            <option value='1' selected>Buku Pegangan Guru</option>
                                                            <option value='2'>Buku Pegangan Siswa</option>
                                                        ";
                                                    } elseif($row->jenis == 2) {
                                                        echo "
                                                            <option value='1'>Buku Pegangan Guru</option>
                                                            <option value='2' selected>Buku Pegangan Siswa</option>
                                                        ";
                                                    }
                                                ?>
                                            </select>
...
function simpan_buku($kode_isbn, $judul_buku, $kategori, $klasifikasi, $kelas, $jenis, $jumlah_buku, $harga_satuan, $pengarang, $penerbit, $tempat_terbit, $tahun_terbit, $jilid_edisi, $sumber_dana, $tanggal_input, $no_buku, $mysqli)
{
    $query = $mysqli->prepare("INSERT INTO buku (kode_isbn, no_buku, judul_buku, pengarang, penerbit, tahun_terbit, tempat_terbit, kategori_buku, jenis, kode_klasifikasi, kelas, jilid_edisi, jumlah_buku, sumber_dana, harga_satuan, tanggal_input) 
                                            VALUES ('$kode_isbn', '$no_buku', '$judul_buku', '$pengarang', '$penerbit', '$tahun_terbit', '$tempat_terbit', '$kategori', '$jenis', '$klasifikasi', '$kelas', '$jilid_edisi', '$jumlah_buku', '$sumber_dana', '$harga_satuan', '$tanggal_input')");
    $query->execute();
...
function edit_buku($id_buku, $kode_isbn, $judul_buku, $kategori, $klasifikasi, $kelas, $jenis, $jumlah_buku, $harga_satuan, $pengarang, $penerbit, $tempat_terbit, $tahun_terbit, $jilid_edisi, $sumber_dana, $no_buku, $mysqli)
{
    $query = $mysqli->prepare("UPDATE buku SET kode_isbn='$kode_isbn', no_buku='$no_buku', judul_buku='$judul_buku', pengarang='$pengarang', penerbit='$penerbit', tahun_terbit='$tahun_terbit', tempat_terbit='$tempat_terbit' , kategori_buku='$kategori', jenis='$jenis', kode_klasifikasi='$klasifikasi', kelas='$kelas', jilid_edisi='$jilid_edisi', jumlah_buku='$jumlah_buku', sumber_dana='$sumber_dana', harga_satuan='$harga_satuan' WHERE id_buku='$id_buku'");
    $query->execute();
}
