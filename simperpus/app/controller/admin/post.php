...
if (isset($_POST['simpan_buku'])) {
    ...
    if($kategori == '1'){
        ...
        $kelas = $_POST['kelaso'];
        $jenis = $_POST['klasifikasi-mp'];
    }else if ($kategori == '0'){
        $klasifikasi = $_POST['klasifikasi-f'];
        $kelas = 'Umum';
        $jenis = 0;
    }else if ($kategori == '2'){
        $klasifikasi = $_POST['non_fiksi'];
        $kelas = 'Umum';
        $jenis = 3;
    }else if ($kategori == '3'){
        $klasifikasi = $_POST['referensi'];
        $kelas = 'Umum';
        $jenis = 4;
    }else{
        $klasifikasi = $_POST['murni'];
        $kelas = 'Umum';
        $jenis = 5;
    }
    ...
    if (mysqli_num_rows($query) == 0) {
        $cek_no_buku = $klasifikasi."0"; //10000
        
        if(strlen($cek_no_buku) == 5){
            $urutan = (int) substr($cek_no_buku, 2, 3);
        }else{
        ...
        $cek_no_buku = $row2['kode_terbesar']; //10001
    ...
    simpan_buku($kode_isbn, $judul_buku, $kategori, $klasifikasi, $kelas, $jenis, $jumlah_buku, $harga_satuan, $pengarang, $penerbit, $tempat_terbit, $tahun_terbit, $jilid_edisi, $sumber_dana, $tanggal_input, $no_buku, $mysqli);
...
if (isset($_POST['edit_buku'])) {
    ...
    if ($token_edit === $token) {
        edit_buku($id_buku, $kode_isbn, $judul_buku, $kategori, $klasifikasi, $kelas, $jenis, $jumlah_buku, $harga_satuan, $pengarang, $penerbit, $tempat_terbit, $tahun_terbit, $jilid_edisi, $sumber_dana, $no_buku, $mysqli);
